...
class Template
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->config['view_path']    = rtrim ($this->config['view_path'],$this->config['view_depr']) . $this->config['view_depr'];
        $this->config['cache_path']    = rtrim ($this->config['cache_path'],$this->config['view_depr']) . $this->config['view_depr'];
    ...
    private function parseTemplateFile($template)
    {
        ...
        if (is_file($template)) {
            ...
            return false;
            // throw new Exception('template not exists:' . $template, 500);
        }
    }
